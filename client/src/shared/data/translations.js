...
export const translations = {
  en: {
    translation: {
      ...
      common: {
        ...
        installment: "Installment via Tabby or Tamara",
        companyDelivery: "Cash upon delivery at the company head office",
        paymentMethod: "Payment Method",
        payment: "Payment Information",
        pleaseSelect: "Please Select Method",
        agreeTerms: "Agree Terms",
        scholarship: "Scholarship",
        wantScholarship: "Do you wish to receive a scholarship?",
        yes: "yes",
        no: "no",
        scholarshipReason: "Reason for applying for a scholarship",
        ...
        Oct: "October,1st",
        Feb: "February,1st",
        startDate: "Course enrollment start date",
        courseLanguage: "Preferred course language",
        ar: "Arabic",
        en: "English",
      ...
      courseDetail: {
        ...
        feedbackError: "Failed to submit feedback",
        deleteFeedbackError: "Failed to delete feedback",
  ...
  ar: {
    translation: {
      ...
      // Arabic translations
      common: {
        details: "للمزيد من تفاصيل الباقات",
        visitor: "زائر",
        ...
        installment: "تقسيط بواسطة تابي او تمارا",
        companyDelivery: "كاش من خلال التسليم في مقر الشركة",
        paymentMethod: "طريقة الدفع",
        payment: "معلومات السداد",
        pleaseSelect: "من فضلك اختر ",
        agreeTerms: "الموافقة على الشروط",
        scholarship: "للحصول على المنحة",
        wantScholarship: "هل ترغب بالحصول على المنحة",
        yes: "أجل",
        no: "لا",
        scholarshipReason: "سبب التقديم للحصول على المنحة",
        ...
        fullNameEn: "الاسم الرباعي باللغة الإنجليزية",
        ...
        Oct: "١ أكتوبر",
        Feb: "١ فبراير",
        startDate: "تاريخ بداية الإلتحاق بالدورة",
        courseLanguage: "اللغة المفضلة للدورة",
        ar: "اللفة العربية",
        en: "اللغة الانجليزية",
        package: "نوع الباقة المختارة",
        basic: "الباقة الأساسية",
        advanced: "الباقة المتقدمة",
        premium: "الباقة المتميزة",
      },
      blogDetail: {
      ...
      courseDetail: {
        ...
        feedbackError: "فشل إرسال التعليق",
        deleteFeedbackError: "لا يمكن حذف التعليق",
        ...
        minutes: "{{count}} دقيقة",
        videoLink: "رابط الفيديو او ملف ال pdf",
