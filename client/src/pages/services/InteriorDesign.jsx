        ...
        <section className="max-w-4xl mx-auto">
          ...
          <section className="bg-white rounded-lg shadow-lg p-8 mb-8">
            <p className="text-gray-600 mb-4">
              ...
              العمارة الداخلية. تهدف خدماتنا في "شركة Ecosus" للتصميم الداخلي في
            ...
            <p className="text-gray-600">
              "شركة Ecosus للتصميم الداخلي" تقدم لك رؤية متكاملة لخدمات تصميم داخلي
          ...
          <section className="bg-white rounded-lg shadow-lg p-8 mb-8">
            <h2 className="text-2xl font-semibold text-blue-900 mb-4 text-center">
              كيف تعمل شركة Ecosus للتصميم الداخلي؟
            </h2>
            <p className="text-gray-600">
              "Ecosus للتصميم" يضيفون لمسة إبداعية لكل تفصيل وعمل في مشروعك. نستخدم
              ...
              بعناية. "Ecosus للتصميم" يقدم خدمات التصميم الداخلي في الدمام مع فريق
          ...
          <section className="bg-white rounded-lg shadow-lg p-8 mb-8">
            ...
            <p className="text-gray-600">
              ...
              وحجم المساحة. نقدم أسعارًا تنافسية ونضمن جودة الخدمات. "Ecosus
          ...
          <section className="bg-white rounded-lg shadow-lg p-8 mb-8">
            <h2 className="text-2xl font-semibold text-blue-900 mb-4">
              ماهي مراحل التصميم الداخلي مع شركة Ecosus في الدمام:
            </h2>
          ...
          <section className="bg-white rounded-lg shadow-lg p-8 mb-8">
            <h2 className="text-2xl font-semibold text-blue-900 mb-4">
              الثقة بين شركة Ecosus للتصميم الداخلي والعملاء:
            </h2>
            <p className="text-gray-600 mb-4">
              "Ecosus للتصميم" تهتم ببناء علاقات قوية مع عملائها. نقدم خدمات شفافة
