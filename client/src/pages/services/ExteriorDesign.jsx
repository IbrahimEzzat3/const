      ...
      <div className="container mx-auto px-4 py-16 rtl">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
            ...
            <p className="text-gray-600 mb-4">
              من خلال التصميم الخارجي لشركة Ecosus، نستطيع بناء واجهة مميزة، كما أن
              لدينا خبرة في اختيار المواد والتشطيبات لضمان أفضل النتائج. "Ecosus"
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
            <h2 className="text-2xl font-semibold text-blue-900 mb-4 text-center">
              شركة Ecosusللتصميم الخارجي في الدمام تقدم لك
            </h2>
            ...
            <p className="text-gray-600">
              إن هذه الخدمات تقدم من "Ecosusللتصميم الخارجي" مع فريق متخصص من
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
            ...
            <p className="text-gray-600 mb-4">
              إن شركة "Ecosusللتصميم الداخلي" في الدمام أو في أي مدينة أخرى في
              الخليج العربي، متميزة في تصميم خارجي. فريقنا يعمل بجد لتقديم أفضل
              التصاميم والحلول.
            </p>
            <p className="text-gray-600">
              جميع موظفينا في "Ecosusللتصميم" يعملون على إبراز خبرتهم في التصميم
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
            <h2 className="text-2xl font-semibold text-blue-900 mb-4 text-center">
              ماذا يعني التصميم الخارجي لشركة Ecosus
            </h2>
