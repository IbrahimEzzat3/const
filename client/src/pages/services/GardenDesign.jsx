        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
            ...
            <p className="text-gray-600 mb-4">
              نقدم في "شاد" لتصميم الحدائق أفضل الخدمات في الدمام والمناطق
            ...
            <p className="text-gray-600">
              في "شاد للتصميم"، نهتم بتحويل رؤيتك إلى واقع. فريقنا من المهندسين
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
            ...
            <p className="text-gray-600">
              في "شاد للتصميم"، نسعى لتقديم أفضل الخدمات بأقل التكاليف. نضمن لك
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
            <h2 className="text-2xl font-semibold text-blue-900 mb-4 text-center">
              كيف يتم تصميم الحدائق المنزلية في شاد في الدمام؟
            </h2>
