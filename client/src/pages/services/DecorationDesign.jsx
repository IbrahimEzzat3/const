        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
            ...
            <p className="text-gray-600">
              فريق "شاد للتصميم" بالدمام خبراء متميزون على أيدي خبراء محليين في
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
            <p className="text-gray-600 mb-4">
              "شاد للتصميم" تقدم لك فريقًا من الاختصاصيين في تصميم الديكور، حيث
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
            ...
            <p className="text-gray-600 mb-4">
              في "شاد للتصميم" نضمن لك أعلى جودة ممكنة من ناحية الجودة والسعر.
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
            <h2 className="text-2xl font-semibold text-blue-900 mb-4 text-center">
              شركة شاد للتصميم الداخلي تقدم لك:
            </h2>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
            <h2 className="text-2xl font-semibold text-blue-900 mb-4 text-center">
              لماذا يجب عليك أن تختار شركة شاد للتصميم الداخلي في الدمام؟
            </h2>
            <p className="text-gray-600 mb-4">
              "شاد للتصميم" تتمتع بخبرة تزيد عن 17 عامًا في مجال التصميم
